...
namespace yelp.Tests
{
    ...
    public class DomainFinderTests
    {
        ...
        [TestMethod()]
        public void GetPlaceIdsTest()
        {
            DomainFinder df = new DomainFinder();
            df.GetPlaceIdsBySearchTerm("Paramount Party Supplies New York, NY");
        }

        [TestMethod()]
        public void CompareGoogleApisTest()
        {
            string location = "New York, NY";
            string category = "partysupplies";
            var yelpResults = Program.GetBusineesesFromYelp(category, 50, location, 0);
